...
export default function Register() {
  ...
  const validate = () => {
    ...
    if (!form.confirmPassword) next.confirmPassword = "Konfirmasi kata sandi wajib diisi.";
    else if (form.confirmPassword !== form.password) next.confirmPassword = "Kata sandi tidak cocok.";
    ...
    try {
      ...
      if (serverErrors) {
        ...
        Object.keys(serverErrors).forEach((key) => {
          // Laravel pakai key "password_confirmation" untuk error rule `confirmed`,
          // sementara field lokal kita namanya "confirmPassword".
          const mappedKey = key === "password_confirmation" ? "confirmPassword" : key;
          flat[mappedKey] = Array.isArray(serverErrors[key]) ? serverErrors[key][0] : serverErrors[key];
        });
        setErrors(flat);
      } else {
        setErrors({ email: "Tidak bisa terhubung ke server. Coba lagi." });
      }
    }
  };
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box; margin:0; padding:0;}
        ...
        .login-card .eyebrow{ color:var(--estuary); margin-bottom:6px; }
        .login-card h1{ font-size:clamp(1.4rem,2vw,1.7rem); margin-bottom:6px; }
        .login-card > p.lead{ color:#556961; font-size:0.88rem; margin-bottom:16px; }
        ...
        .field label{
          ...
          font-size:0.92rem; color:#7A8A83;
          pointer-events:none;
          transition:all .18s ease;
        }
        .field input:focus + label,
        .field input:not(:placeholder-shown) + label{
          top:6px; left:46px; font-size:0.65rem; font-weight:700;
        ...
        .terms-check{
          ...
          font-size:0.85rem; color:#556961; line-height:1.5;
        }
        .terms-check input{ accent-color:var(--estuary); width:15px; height:15px; cursor:pointer; margin-top:2px; flex-shrink:0; }
        .terms-check a{ font-weight:700; color:var(--estuary); }
        .terms-check a:hover{ color:var(--canopy); }
        ...
        .login-submit{
          ...
          font-weight:700; font-size:0.94rem; font-family:'Plus Jakarta Sans', sans-serif;
          cursor:pointer;
        ...
        .btn-google{
          ...
          border:1.5px solid rgba(15,36,29,0.14);
          font-weight:700; font-size:0.9rem; font-family:'Plus Jakarta Sans', sans-serif;
          cursor:pointer;
        ...
        .login-divider{
          ...
          font-size:0.76rem; color:#8A9A93; font-weight:600;
        }
        ...
        @media (max-width:960px){
          ...
          .login-form-side{ padding:20px 20px; height:100%; }
      ...
      <div className="login-page">
        ...
        <div className="login-visual">
          ...
          <div className="login-visual-copy">
            <span className="eyebrow">Mulai Perjalanan</span>
            <h2>Satu akun, seluruh ekosistem belajar.</h2>
            <p>
              Daftar untuk mulai menjelajahi ekosistem mangrove — dari materi
              interaktif, laboratorium virtual, hingga kuis berpikir kausal
              yang mengasah pemahamanmu.
            </p>
          </div>
        ...
        <div className="login-form-side">
          <div className={`login-card${shake ? " shake" : ""}`} ref={cardRef}>
            <span className="eyebrow">Buat Akun Baru</span>
            <h1>Bergabung dengan MangrovEdu</h1>
            <p className="lead">Daftar sekarang untuk mulai belajar ekosistem mangrove secara interaktif.</p>
                ...
                <label className="terms-check">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setErrors((err) => ({ ...err, agree: null }));
                    }}
                  />
                  <span>
                    Saya menyetujui <Link to="/syarat-ketentuan">Syarat & Ketentuan</Link> serta{" "}
                    <Link to="/kebijakan-privasi">Kebijakan Privasi</Link> MangrovEdu.
                  </span>
                </label>
            ...
            <p className="signup-cta" style={{ marginTop: 12 }}>
